...
var resDisp = {
    map:    ['email', nonReqField[0], rngField[0], rngField[1], nonReqField[1], reqField[0], reqField[1], 
...
//fields for db input - confirmed.js
var allFields = {
    map: resDisp.map,
    type: ['String', 'String', 'Number', 'Number', 'String', 'String', 'String', 'Number', 'Number'];
};
...
//get methods for allFields variable for db input - confirmed.js
exports.getAllFieldsLen = function() {
    return allFields.map.length;
}
exports.getAllFieldsMap = function(num) {
    return allFields.map[num];
};
exports.getAllFieldsType = function(num) {
    return allFields.type[num];
};
